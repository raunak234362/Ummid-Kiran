    ...
    const services = [
        {
          ...
          title: "Physiotherapy",
          description: "Specialized physical therapy to improve mobility, strength, and coordination.",
        ...
        },
        {
          ...
          description: "Developing daily living skills and functional independence.",
          iconBgColor: "bg-orange-100",
        },
        {
          icon: <Smile className="text-blue-500" />,
          title: "Play Therapy",
          description: "Therapeutic play activities for emotional and social development.",
          iconBgColor: "bg-blue-100",
        },
        {
          icon: <User className="text-yellow-500" />,
          title: "Postural Therapy",
          description: "Improving posture and body alignment for better functionality.",
          iconBgColor: "bg-yellow-100",
        },
        {
          icon: <Music className="text-orange-500" />,
          title: "Art & Music Therapy",
          description: "Creative expression for emotional and cognitive development.",
          iconBgColor: "bg-orange-100",
        },
      ]
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-12">
        <h2 className="text-4xl font-bold text-blue-600 mb-2">Our Services</h2>
        <div className="w-24 h-1 bg-yellow-400 mx-auto mb-6"></div>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Comprehensive therapeutic services tailored to enhance the development and well-being of our special children
        </p>
      </div>
